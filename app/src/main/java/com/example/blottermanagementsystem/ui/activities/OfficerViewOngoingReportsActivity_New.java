...
public class OfficerViewOngoingReportsActivity_New extends BaseActivity {
    ...
    private void loadReportsFromApi() {
        ...
        ApiClient.getAllReports(new ApiClient.ApiCallback<List<BlotterReport>>() {
                ...
                Executors.newSingleThreadExecutor().execute(() -> {
                    try {
                        ...
                        runOnUiThread(() -> {
                            ...
                            filterReports();
                            android.util.Log.d("OfficerOngoing", "✅ Updated with API data: " + apiReports.size() + " reports");
                        });
                    } catch (Exception e) {
            ...
            public void onError(String errorMessage) {
                android.util.Log.w("OfficerOngoing", "API error: " + errorMessage + " - Using cached data");
    ...
    private void filterReports() {
        ...
        if (allReports.isEmpty()) {
            android.util.Log.d("OfficerOngoing", "⏳ Skipping filter - data not loaded yet");
            return;
        }
