...
public class ViewResolvedReportsActivity extends BaseActivity {
    ...
    private TextView tvTotalCount, tvPendingCount, tvAssignedCount, tvOngoingCount, tvResolvedCount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            android.util.Log.d("ViewResolvedReports", "Starting onCreate...");
            setContentView(R.layout.activity_view_resolved_reports);
            ...
            android.util.Log.d("ViewResolvedReports", "onCreate completed successfully");
        } catch (Exception e) {
            android.util.Log.e("ViewResolvedReports", "Error in onCreate: " + e.getMessage(), e);
            showErrorState();
        }
    }
    ...
    private void initializeViews() {
        try {
            ...
            if (recyclerReports != null) {
                adapter = new ReportAdapter(filteredReports, report -> {
                    try {
                        ...
                        android.util.Log.e("ViewResolvedReports", "Error opening report detail: " + e.getMessage());
                    }
                });
            ...
            android.util.Log.e("ViewResolvedReports", "Error initializing views: " + e.getMessage());
            throw e;
        }
    }
    ...
    private void setupListeners() {
        try {
            ...
            android.util.Log.e("ViewResolvedReports", "Error setting up listeners: " + e.getMessage());
        }
    }
            ...
            if (chipScrollView != null && chip != null) {
                ...
                chipScrollView.postDelayed(() -> {
                    try {
                        ...
                        android.util.Log.e("ViewResolvedReports", "Error scrolling to chip: " + e.getMessage());
                    }
                }, 100); // 100ms delay to ensure layout is ready
            }
        } catch (Exception e) {
            android.util.Log.e("ViewResolvedReports", "Error in scrollToChip: " + e.getMessage());
        }
    }
    ...
    private void navigateToScreen(Class<?> activityClass) {
        try {
            ...
            android.util.Log.e("ViewResolvedReports", "Navigation error: " + e.getMessage());
        ...
        if (chipScrollView != null) {
            chipScrollView.post(() -> {
                try {
                    ...
                    android.util.Log.e("ViewResolvedReports", "Error restoring scroll: " + e.getMessage());
                }
            });
        }
    }
    ...
    private void autoSelectCurrentChip() {
        ...
        new android.os.Handler().postDelayed(() -> {
            try {
                ...
                android.util.Log.e("ViewResolvedReports", "Error auto-selecting chip: " + e.getMessage());
            }
        }, 100);
    }
    ...
    private void loadReportsFromApi() {
        ApiClient.getAllReports(new ApiClient.ApiCallback<List<BlotterReport>>() {
            ...
            @Override
            public void onError(String errorMessage) {
                android.util.Log.w("ViewResolvedReports", "API error: " + errorMessage);
                loadReportsFromDatabase();
            }
        });
    }
    ...
    private void updateStatistics() {
        ...
        android.util.Log.d("Statistics", 
            "Resolved Stats - Total: " + total + 
            ", Pending: " + pending + 
            ", Assigned: " + assigned + 
            ", Ongoing: " + ongoing + 
            ", Resolved: " + resolved);
    ...
    protected void onResume() {
        ...
        android.util.Log.d("ViewResolvedReports", "🔄 onResume() - Refreshing data...");
        loadReports();
    ...
    private void updateStatisticsFromDatabase() {
        ...
        java.util.concurrent.Executors.newSingleThreadExecutor().execute(() -> {
            try {
                ...
                android.util.Log.e("ViewResolvedReports", "Error updating statistics: " + e.getMessage());
            }
        });
    }
        ...
        Runnable refreshRunnable = new Runnable() {
            ...
            public void run() {
                ...
                if (!isFinishing() && !isDestroyed()) {
                    android.util.Log.d("ViewResolvedReports", "🔄 Periodic refresh triggered");
            ...
            try {
                ...
                if (dataChanged) {
                    runOnUiThread(() -> {
                        ...
                        filterReports();
                        updateStatistics();
                        android.util.Log.d("ViewResolvedReports", "✅ Quiet refresh - UI updated");
                    });
                }
            } catch (Exception e) {
                android.util.Log.e("ViewResolvedReports", "❌ Error in quiet refresh: " + e.getMessage());
            }
        });
    }
    ...
    private boolean hasDataChanged(List<BlotterReport> newReports, List<BlotterReport> oldReports) {
        if (newReports.size() != oldReports.size()) {
            android.util.Log.d("ViewResolvedReports", "📊 Data changed: Different report count");
            return true;
        }
        ...
        for (int i = 0; i < newReports.size(); i++) {
            ...
            if (newReport.getId() != oldReport.getId() ||
                ...
                android.util.Log.d("ViewResolvedReports", "📊 Data changed: Report content modified");
                return true;
            }
        }
        
        android.util.Log.d("ViewResolvedReports", "📊 No data changes detected");
        return false;
    }
