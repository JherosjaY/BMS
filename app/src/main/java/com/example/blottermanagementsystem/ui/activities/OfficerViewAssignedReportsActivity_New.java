...
public class OfficerViewAssignedReportsActivity_New extends BaseActivity {
    ...
    private void loadReportsFromApi() {
        ...
        ApiClient.getAllReports(new ApiClient.ApiCallback<List<BlotterReport>>() {
                ...
                new Thread(() -> {
                    try {
                        ...
                        runOnUiThread(() -> {
                            ...
                            updateStatistics();
                            filterReports();
                            android.util.Log.d("OfficerAssigned", "✅ Updated with API data: " + apiReports.size() + " reports");
                        });
                    } catch (Exception e) {
            ...
            public void onError(String errorMessage) {
                android.util.Log.w("OfficerAssigned", "API error: " + errorMessage + " - Using cached data");
    ...
    private void filterReports() {
        ...
        if (allReports.isEmpty()) {
            android.util.Log.d("OfficerAssigned", "⏳ Skipping filter - data not loaded yet");
            return;
        }
