...
public class SplashActivity extends AppCompatActivity {
    ...
    private void createAdminAccountIfNotExists() {
        android.util.Log.d("SplashActivity", "⚠️ createAdminAccountIfNotExists() DISABLED - Pure Neon mode");
        android.util.Log.d("SplashActivity", "✅ Admin account is in Neon backend (bms.official.admin / BMS2025)");
