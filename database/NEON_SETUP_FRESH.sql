-- ============================================================================
-- BMS COMPLETE NEON SETUP - FRESH INSTALLATION (NO DROP STATEMENTS)
-- ============================================================================
-- This file contains ALL database schemas needed for BMS
-- Use this for FRESH Neon instances (no existing tables)
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS hearing_attendees (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS person_risk_levels (
    id SERIAL PRIMARY KEY,
    person_id VARCHAR(255) NOT NULL REFERENCES person_profiles(person_id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_hearing_attendees_hearing_id ON hearing_attendees(hearing_id);
CREATE INDEX IF NOT EXISTS idx_hearing_attendees_user_id ON hearing_attendees(user_id);
CREATE INDEX IF NOT EXISTS idx_hearing_minutes_hearing_id ON hearing_minutes(hearing_id);
CREATE INDEX IF NOT EXISTS idx_hearing_notifications_user_id ON hearing_notifications(user_id);
CREATE INDEX IF NOT EXISTS idx_hearing_notifications_is_read ON hearing_notifications(is_read);

CREATE INDEX IF NOT EXISTS idx_person_profiles_person_id ON person_profiles(person_id);
CREATE INDEX IF NOT EXISTS idx_criminal_records_person_id ON criminal_records(person_id);
CREATE INDEX IF NOT EXISTS idx_criminal_records_status ON criminal_records(status);
CREATE INDEX IF NOT EXISTS idx_case_involvement_person_id ON case_involvement(person_id);
CREATE INDEX IF NOT EXISTS idx_case_involvement_case_id ON case_involvement(case_id);
CREATE INDEX IF NOT EXISTS idx_person_risk_levels_person_id ON person_risk_levels(person_id);
